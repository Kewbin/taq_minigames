...
tellraw @a[nbt={Dimension:"minecraft:minigames"}] ["",{"text":"[","bold":true,"color":"gold"},{"text":"!","bold":true,"color":"yellow"},{"text":"] ","bold":true,"color":"gold"},{"selector":"@s","bold":true,"color":"dark_purple"},{"text":" has found a mythic!","color":"light_purple"}]
